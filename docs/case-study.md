...
This pipeline processes settlement statements generated by **Adyen** (Payment Service Provider).The data model, file structure, and settlement semantics follow [Adyen’s settlement report specifications](https://docs.adyen.com/reporting/settlement-reconciliation/transaction-level/settlement-details-report)
